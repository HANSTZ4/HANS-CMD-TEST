...
zokou({ nomCom: "dev", categorie: "General", reaction: "🇹🇿" }, async (dest, zk, commandeOptions) => {
    ...
    let message = "WELCOME TO HANS HELP CENTER! ASK FOR HELP FROM ANY OF THE DEVELOPERS BELOW:\n\n";
...
zokou({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  repondre("THANK YOU FOR CHOOSING HANS, HERE ARE OUR SUPPORTIVE LINKS\n\n ☉ CHANNEL LINK IS HERE ☉ \n\n❒⁠⁠⁠⁠[https://whatsapp.com/channel/0029VajweHxKQuJP6qnjLM31] \n\n ☉ HANSTZ CHAT INBOX ☉\n\n❒⁠⁠⁠⁠[https://wa.me/message/R4N3KQOD7APXD1] \n\n ☉HANS-MD REPO LINK IS HERE ☉\n\n❒⁠⁠⁠⁠[https://github.com/HANSTZ3/HANS-MD-V3] \n\n\n𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝒃𝒚 Hans Tz") 
