...
zokou({
  ...
  if (!arg[0]) {
    repondre("wrong!!! Ie. _Play hozambe by Hans ft shifura._");
    return;
  }
...
zokou({
  ...
  if (!arg[0]) {
    repondre("insert video name Ie. _video hozambee by Hans ft shifura._");
    return;
  }
...
\n\n\n HANSTZ`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "HANSTZ", gifPlayback: false }, { quoted: ms });
      });
